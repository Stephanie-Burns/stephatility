...
from src.constants import ASSETS_DIR, USER_SETTINGS_JSON
...
class StephaTility(tk.Frame):
    def __init__(self, parent: tk.Misc, user_settings: UserSettings, **kwargs):
        ...
        self.network_center = NetworkCenter(
            self,
            self.user_settings.network_center,
            self.thread_manager
        )
...
def main():
    ...
    app = StephaTility(root, user_settings)
